    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new BookmarksViewModel(singletonCImpl.bookmarkRepositoryProvider.get(), singletonCImpl.authServiceProvider.get());
          ...
          return (T) new OnboardingViewModel(singletonCImpl.preferencesRepositoryProvider.get(), singletonCImpl.tagRepositoryProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
          ...
          return (T) new TicketsViewModel(singletonCImpl.ticketRepositoryProvider.get(), singletonCImpl.authServiceProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new PaymentService(singletonCImpl.provideFirebaseFunctionsProvider.get(), singletonCImpl.authServiceProvider.get());
