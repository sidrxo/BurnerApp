...
public final class TicketsViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<String> {
  @Override
  public String get() {
    return provide();
  }
  ...
  public static String provide() {
    return Preconditions.checkNotNullFromProvides(TicketsViewModel_HiltModules.KeyModule.provide());
  }
