...
internal val logger: SkipLogger = SkipLogger(subsystem = "burner.module", category = "BURNER")

private typealias AppRootView = BURNERRootView
private typealias AppDelegate = BURNERAppDelegate
